...
function pairing_heap_class:_new()
	self._max_node = {}
	self._nodes_by_value = {}
	self._size = 0
end

function pairing_heap_class:size()
	return self._size
end

function pairing_heap_class:peek_max()
	local hn = self._max_node
	return hn.value, hn.priority
end

function pairing_heap_class:delete(value)
	self:set_priority(value, inf)
	return self:delete_max()
end

function pairing_heap_class:delete_max()
...
function pairing_heap_class:get_priority(value)
...
function pairing_heap_class:set_priority(value, priority)
...
action_queues.pairing_heap_class = pairing_heap_class
